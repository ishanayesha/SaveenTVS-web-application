            ...
            <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo base_url() ?>index.php">Home</a> <i class="fa fa-angle-right"></i>Sell a bike</li>
            </ol>
...
<form action="<?php echo base_url()?>index.php/Bike/bill" method="post" class="form-horizontal">    
                         ...
                         <div class="form-horizontal" style="padding-left: 15%;text-align: left;">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input style="font-size: 1.1em;text-align: left;" class="col-sm-6 control-label" id="price" name="price" value="Rs: <?php echo $bike[0]->price;?>">
                                    </div>
                            </div>
